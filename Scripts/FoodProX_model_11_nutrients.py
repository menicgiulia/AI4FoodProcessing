...
params_file = os.path.join(model_dir, "FoodProX_model_11_nutrients_no_class_balancing_Params.pkl")
cv_metrics_file = os.path.join(metrics_dir, "FoodProX_model_11_nutrients_no_class_balancing_CVmetrics.pkl")
metrics_prefix = os.path.join(metrics_dir, "FoodProX_model_11_nutrients_no_class_balancing")
models_prefix = os.path.join(model_dir,"FoodProX_model_11_nutrients_no_class_balancing")
timing_file = os.path.join(model_dir, "FoodProX_model_11_nutrients_no_class_balancing_Timing.pkl")
