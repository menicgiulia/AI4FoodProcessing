...
params_file = os.path.join(model_dir, "BERT_XGBoost_Classifier_Params.pkl")
cv_metrics_file = os.path.join(metrics_dir, "BERT_XGBoost_Classifier_CVmetrics.pkl")
metrics_prefix = os.path.join(metrics_dir, "BERT_XGBoost_Classifier")
models_prefix= os.path.join(model_dir, "BERT_XGBoost_Classifier")
timing_file = os.path.join(model_dir, "BERT_XGBoost_Classifier_Timing.pkl")
...
xgb = XGBClassifier(
    ...
    eval_metric='logloss',
    tree_method='hist',   # fast on big data
    n_jobs=1,             # <-- force single‑thread per fit
