...
params_file = os.path.join(model_dir, "BERT_Neural_Network_Classifier_Params.pkl")
cv_metrics_file = os.path.join(metrics_dir, "BERT_Neural_Network_Classifier_CVmetrics.pkl")
metrics_prefix = os.path.join(metrics_dir, "BERT_Neural_Network_Classifier")
models_prefix= os.path.join(model_dir, "BERT_Neural_Network_Classifier")
timing_file = os.path.join(model_dir, "BERT_Neural_Network_Classifier_Timing.pkl")
